        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form id="form_validation" action="/gyms" method="POST">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group form-float">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input id="time" type="time" class="timepicker form-control" name="opening_time" required>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="time" class="timepicker form-control time24" name="closing_time"  required>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="number" class="form-control" name="lon" id="lng" step="any" required>
